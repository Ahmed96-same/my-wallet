...
const TEMPLATES = [
  {
    ...
    response: `أهلاً وسهلاً! 🌟\n\nشكراً لتواصلك معنا، يسعدنا خدمتك 😊\n\nلتقديم أفضل سعر مناسب لك، نحتاج بعض التفاصيل:\n📐 المقاسات المطلوبة (الطول × العرض × الارتفاع)\n🎨 الخامة أو اللون المفضل\n📦 الكمية المطلوبة\n\nأرسل لنا هذه التفاصيل وسنرسل لك عرض السعر فوراً! 💫`,
  },
  {
    key: "availability",
    label: "توفر المنتج",
    ...
    response: `مرحباً! 😊\n\nنعم المنتج متوفر لدينا حالياً بعدة خيارات رائعة:\n✅ ألوان ومقاسات متعددة\n✅ خامات مختلفة تناسب جميع الأذواق\n✅ جاهز للتسليم الفوري\n\nهل تودّ أن نرسل لك صور المنتجات المتوفرة؟ 📸`,
  },
  {
    key: "delivery",
    ...
    response: `أهلاً! 🚚\n\nنعم نوفر خدمة التوصيل لجميع المناطق:\n📍 داخل المدينة: 1-2 يوم عمل\n🗺️ خارج المدينة: 3-5 أيام عمل\n🏠 التوصيل حتى باب المنزل مع التركيب\n\nأرسل لنا عنوانك الكامل وسنتواصل معك بتفاصيل التوصيل! 📲`,
  },
  {
    key: "custom",
    label: "طلب خاص / تفصيل",
    ...
    response: `أهلاً بك! ✨\n\nبالتأكيد نقبل الطلبات الخاصة حسب مقاساتك وذوقك 🎨\n\nلبدء طلبك نحتاج:\n📐 المقاسات (الطول × العرض × الارتفاع)\n🎨 اللون أو الخامة المفضلة\n🖼️ صور مرجعية للشكل المطلوب (اختياري)\n\nسنرسل لك عرض السعر والمدة الزمنية للتنفيذ فوراً! 💪`,
  },
  {
    key: "warranty",
    ...
    response: `مرحباً! 🛡️\n\nنفخر بجودة منتجاتنا العالية:\n✅ خامات مختارة بعناية ومعتمدة\n✅ تشطيب احترافي فائق الجودة\n✅ ضمان ضد عيوب الصناعة\n✅ خدمة ما بعد البيع متميزة\n\nعملاؤنا الكرام خير شاهد على جودتنا! 💎`,
  },
  {
    key: "colors",
    ...
    response: `أهلاً! 🎨\n\nلدينا تشكيلة رائعة من الألوان:\n🤍 أبيض وكريمي\n🖤 أسود وأنثراسيت\n🟤 بني وخشبي طبيعي\n💙 رمادي وأزرق هادئ\n💛 بيج وذهبي فاخر\n\nيمكننا أيضاً تنفيذ أي لون تختاره! هل تريد أن نرسل لك كتالوج الألوان؟ 🌈`,
  },
  {
    key: "complaint",
    label: "شكوى أو مشكلة",
    ...
    response: `عزيزنا العميل 🙏\n\nنأسف جداً على هذه التجربة، رضاك يهمنا فوق كل شيء.\n\nمن فضلك أرسل لنا:\n📸 صور توضح المشكلة بوضوح\n🔢 رقم الطلب أو الفاتورة\n📞 رقم هاتفك للتواصل المباشر\n\nسنتواصل معك في أقرب وقت لحل المشكلة فوراً! 💚`,
  },
  {
    key: "greeting",
    label: "ترحيب عام",
    ...
    response: `أهلاً وسهلاً! 👋✨\n\nمرحباً بك في عالم الأثاث الفاخر 🛋️\nيسعدنا خدمتك وتلبية جميع احتياجاتك.\n\nكيف يمكننا مساعدتك اليوم؟\n💰 استفسار عن الأسعار\n📦 توفر المنتجات\n✂️ طلبات خاصة وتفصيل\n🚚 استفسار عن التوصيل\n\nنحن هنا لخدمتك! 😊`,
  },
];
